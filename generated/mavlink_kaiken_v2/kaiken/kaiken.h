/** @file
 *  @brief MAVLink comm protocol generated from kaiken.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_KAIKEN_H
#define MAVLINK_KAIKEN_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_KAIKEN.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif

#define MAVLINK_KAIKEN_XML_HASH -7837879301600447219
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_fmu_tm.h"
#include "./mavlink_msg_rtk_tm.h"
